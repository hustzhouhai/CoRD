...
//        _helpersIPs.push_back(inet_addr(ele -> GetText()));
  ...
  std::cout << "_ecM = " << _ecN - _ecK << std::endl;
  std::cout << "update.policy: " << _UPPolicy << std::endl;
  std::cout << "update.opt: " << _flipOpt << std::endl;
  std::cout << "log.size: " << _log_size << "MB" << std::endl;
  std::cout << "update.request.way: " << _UPWay << std::endl;
  std::cout << "block.size(KB): " << _blocksize << std::endl;
  std::cout << "update.block.directory: " << _updDataDir << std::endl;
  std::cout << "trace.directory: " << _traceDir << std::endl;
  std::cout << "trace.type: " << _traceType << std::endl;
  std::cout << "\t _helpersIPs: " << std::endl;
  for (auto it : _helpersIPs) {
    std::cout << "\t\t" << std::to_string((it >> 24) & 0xff) << std::endl;
  }
}
