...
//Integrate ECPipe
extern unsigned int ecpipeCoIP;
extern unsigned int ecpipeLocIP;
extern string ecpipeDRPolicy;
extern string ecpipeECPipePolicy;
extern int ecpipePacketSize;
extern int ecpipePacketCount;
...
ChunkServerMain::LoadParams(const char* fileName)
{
    ...
    ecpipeCoIP = inet_addr(mProp.getValue("chunkServer.ECPipe.coordinatorIP", "0.0.0.0"));
    ecpipeLocIP = inet_addr(mProp.getValue("chunkServer.ECPipe.localIP", "0.0.0.0"));
    ecpipeDRPolicy = mProp.getValue("chunkServer.ECPipe.degradedReadPolicy", "ecpipe");
    KFS_LOG_STREAM_INFO << "chunkserver_main :: ecpipeDRPolicy = " << ecpipeDRPolicy << KFS_LOG_EOM;
    ecpipeECPipePolicy = mProp.getValue("chunkServer.ECPipe.ECPipePolicy", "basic");
    KFS_LOG_STREAM_INFO << "chunkserver_main :: ecpipeECPipePolicy = " << ecpipeECPipePolicy << KFS_LOG_EOM;
    ecpipePacketSize = mProp.getValue("chunkServer.ECPipe.PacketSize", (unsigned int) 32768);
    KFS_LOG_STREAM_INFO << "chunkserver_main :: ecpipePacketSize = " << ecpipePacketSize << KFS_LOG_EOM;
    ecpipePacketCount = mProp.getValue("chunkServer.ECPipe.PacketCount", (unsigned int) 32);
    KFS_LOG_STREAM_INFO << "chunkserver_main :: ecpipePacketCount = " << ecpipePacketCount << KFS_LOG_EOM;
