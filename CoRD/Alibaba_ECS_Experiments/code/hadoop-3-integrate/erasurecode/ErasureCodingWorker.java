...
public final class ErasureCodingWorker {
  ...
  public ErasureCodingWorker(Configuration conf, DataNode datanode) {
    ...
    // add by Zuoru: ECPipe
    this.isECPipe = conf.getBoolean(
        DFSConfigKeys.DFS_DN_EC_ECPIPE_KEY,
        DFSConfigKeys.DFS_DN_EC_ECPIPE_DEFAULT
    );
    ///
  ...
  public void processErasureCodingTasks(
    ...
    for (BlockECReconstructionInfo reconInfo : ecTasks) {
        LOG.info("Test by Zuoru: processErasureCodingTasks:" + reconInfo);
      ...
      try {
        ...
        // add by Zuoru: add ECPipe
         if (isECPipe){
            LOG.info("Test by Zuoru: Recovery by ECPipe");
            final ECPipeReconstructor task =
                new ECPipeReconstructor(this, stripedReconInfo);
